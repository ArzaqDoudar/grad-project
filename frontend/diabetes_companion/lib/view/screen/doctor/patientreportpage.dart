...
import '/view/widget/bottombardoctor.dart';
import 'package:flutter/foundation.dart';

import '../../../controller/doctor/patientreportcontorller.dart';
...
class PatientReportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(PatientReportControllerImp());
    final screenWidth = MediaQuery.of(context).size.width;

    return GetBuilder<PatientReportControllerImp>(builder: (controller) {
      return Scaffold(
        backgroundColor: ColorApp.white,
        appBar: AppBar(
            centerTitle: true,
            backgroundColor: ColorApp.blue,
            title: Text('تقرير ${controller.patientName!}')),
        body: HandlingDataView(
          statusRequest: controller.statusRequest,
          widget: Padding(
            padding: const EdgeInsets.symmetric(vertical: 20),
            child: GetBuilder<PatientReportControllerImp>(
