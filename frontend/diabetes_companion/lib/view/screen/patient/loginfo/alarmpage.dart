...
import '/view/widget/customdropdowntextfield.dart';
import '/view/widget/datetime/basictimefield.dart';
import 'package:dropdown_textfield/dropdown_textfield.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../../../controller/patient/alarmcontroller.dart';
...
class AlarmPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AlarmControllerImp>(builder: (controller) {
      return Center(
        child: Stack(
          children: <Widget>[
            Container(
            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  BasicTimeField(controller: controller.time),
                  const SizedBox(
                    height: 10,
                  ),
                  CustomDropDownTextField(
                    ...
                    items: const [
                      DropDownValueModel(name: 'موعد دواء', value: "medicin"),
                      DropDownValueModel(
                          name: 'موعد قياس جرعة', value: "glocose"),
                      DropDownValueModel(
                          name: 'موعد مراجعة طبيب', value: "doctor"),
                    ],
                  ),
                  const SizedBox(
                    height: 10,
                  ...
                  TextButton(
                    ...
                    onPressed: () => controller.showAlarm(),
                  ),
                ],
              ),
            ),
