...
const routeCarbs = require('./route/carbs');
const routePatientAdmin = require('./route/admin/patientadmin');
...
app.use('/store' , cors(), routeStore); 
app.use('/store/product' , cors(), routeProduct); 
app.use('/carbs' , cors(), routeCarbs); 
app.use('/admin/patients' , cors(), routePatientAdmin); 
app.use('/test' , cors(), routeTest); 
